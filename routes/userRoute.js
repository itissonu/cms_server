...
const { userRegister, userLogin, getaUser, getAlluser, updateUser, OTPverificationUser, Logout, DeleteAUser, getaUserByRegdNo, getuserBySectionsAndall } = require('../controller/userController');
...
router.get('/getuserbysectionandall',getuserBySectionsAndall);
